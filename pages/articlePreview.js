...
function articlePreview() {
    return (
        <div className=" bg-gray-300 h-screen px-8 pt-8 w-full">
            <Head>
                <title>Article Preview Challenge</title>
            </Head>
            <div className="mx-auto md:w-3/5 md:flex md:h-auto">
                <img src="/images/drawers.jpeg" className="rounded-tr-md rounded-tl-md h-48 w-full md:h-auto md:w-2/5 md:rounded-bl-md md:rounded-tl-md " alt="" />
                <div className="bg-white p-8 rounded-bl-md rounded-br-md rounded-tr-md md:rounded-bl-none ">
